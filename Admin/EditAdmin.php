...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="admin">
                <b>Admin > Edit Admin</b>
                <p>Admin > Edit Admin</p>
            </div>
            ...
            <div class="edit-admin">
                ...
                <form action="EditAdminProcess.php" method="post" enctype="multipart/form-data">
                    <h3>Edit Admin</h3>

                
                    <input name="email" id="email" type="email" class="box" placeholder="Email" value="<?php echo $data["AdminEmail"]; ?>">
            
                    <input name="Name" id="Name" type="text" class="box" placeholder="Name" value="<?php echo $data["Name"]; ?>">
                                
                    <input name="phoneNumber" id="phoneNumber" type="number" class="box" placeholder="Phone Number" value="<?php echo $data["PhoneNum"]; ?>">
              
                        <!-- using onfocus="(this.type='date')" -->
                    <input name="DOB" id="DOB" type="text" class="box" placeholder="Date of Birth" onfocus="(this.type='date')" value="<?php echo $data["DOB"]; ?>" >
                    ...
                    <input name="password" id="password" type="password" class="box" placeholder="Password" value="<?php echo $data["Password"]; ?>">
