    ...
    <div class="container">
        ...
        <div class="main">
                ...
                <div class="toggle"><i class="fas fa-solid fa-bars"></i></div>    
                    ...
                    <div class="search">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM owner WHERE OwnerEmail LIKE '%" . $txtSearch . "%'";
            ...
            <div class="playerBox">
                ...
                <a class="owner-btn" href="RegOwner.php" role="button">Register Store Owner</a>
                <br><br>
                        ...
                        while ($row= mysqli_fetch_array($query)) {
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["OwnerPhoneNum"] ?></td>
                                    <td><?php echo $row["OwnerDOB"] ?></td>
                                    <td>
                                        <a class="edit" href="EditOwner.php?OwnerEmail=<?php echo $row["OwnerEmail"]; ?>"> Edit </a>
                                        <br>
                                        <a onclick="return Delete()" class="delete" href="DeleteOwner.php?OwnerEmail=<?php echo $row["OwnerEmail"]; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php
