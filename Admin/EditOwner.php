...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="owner">
                <b>Store Owner > Edit Store Owner</b>
                <p>Store Owner > Edit Store Owner</p>
            </div>
            ...
            <div class="edit-owner">
                ...
                <form action="EditOwnerProcess.php" method="post" enctype="multipart/form-data">
                    <h3>Edit Owner</h3>

                
                    <input name="email" id="email" type="email" class="box" placeholder="Email" value="<?php echo $data["OwnerEmail"]; ?>">
            
                    <input name="Name" id="Name" type="text" class="box" placeholder="Name" value="<?php echo $data["OwnerName"]; ?>">
                                
                    <input name="phoneNumber" id="phoneNumber" type="number" class="box" placeholder="Phone Number" value="<?php echo $data["OwnerPhoneNum"]; ?>">
              
                        <!-- using onfocus="(this.type='date')" -->
                    <input name="DOB" id="DOB" type="text" class="box" placeholder="Date of Birth" onfocus="(this.type='date')" value="<?php echo $data["OwnerDOB"]; ?>" >
                    ...
                    <input name="password" id="password" type="password" class="box" placeholder="Password" value="<?php echo $data["OwnerPassword"]; ?>">
