    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <!-- checkpoints -->
                <li>
                    <a href="checkpoint.php" class="active">
                        <span class="icon">
                    ...
                    <div class="search">
                        <div class="cari">
                            <form action="checkpoint.php" method="POST">
                                <input class="searchbox" type="text" name="txtsearch" placeholder="Search by player email">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM checkpoint WHERE PlayerEmail LIKE '%" . $txtSearch . "%'";
                    ...
                    while ($row= mysqli_fetch_array($query)) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row["CheckpointID"] ?></td>
                                <td><img src="<?php echo "/FYP/Owner/photo/".$row["CPUpload"] ?>" style="height: 50px;" ></td>
                                <td><?php echo $row["StoreID"] ?></td>
                                <td><?php echo $row["PlayerEmail"] ?></td>
                                <td>  <?php 
                                            if (isset($row['CPStatus']) && $row['CPStatus'] == 1) {
