...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="add-store">
                ...
                <form action="AddStoreProcess.php" method="post" enctype="multipart/form-data">
                <h3>add store</h3>

            
                <input type="text" id="StoreName" name="StoreName" class="box" placeholder="Enter Name">

                <input type="text" id="StoreAddress" name="StoreAddress" class="box" placeholder="Enter Address">

                <input type="text" id="StorePhoneNum" name="StorePhoneNum" class="box" placeholder="Enter Phone Number">

                <input type="text" id="StoreLocation" name="StoreLocation" class="box" placeholder="Enter Location Link">

                <input type="text" id="StoreMission" name="StoreMission" class="box" placeholder="Enter Mission">

                <select name="StoreCategory" id="StoreCategory" class="box">
                    <option disabled selected hidden>Select</option>
                    <option value="1">Food Hunting</option>
                    <option value="2">Sightseeing</option>
                    <option value="3">Museum</option>
                </select>

                <input type="email" id="OEmail" name="OEmail" class="box" placeholder="Enter Owner Email">

                <input type="file" id="StorePhoto" name="StorePhoto" accept="image/jpg, image/jpeg, image/png" class="upload-box">

                <input type="submit" value="Add" name="add_store" class="add-btn">
    ...
    <script>
        ...
        function increment() {
            var inputField = document.getElementById('autoIncrementField');
