        ...
        <div class="main">
            ...
            <div class="playerBox">
                ...
                <table>
                    ...
                    $sqlP = "SELECT c.CheckpointID, c.CPUpload, c.CPhotoType, c.CPhotoSize, c.StoreID, c.CPStatus, p.PlayerName, p.PlayerPhoneNum, p.PlayerDOB, p.PlayerCountry, p.PlayerStatus, p.AdminEmail, p.PlayerEmail FROM Checkpoint c JOIN Player p ON c.PlayerEmail = p.PlayerEmail WHERE c.CPStatus = 0";
                    ...
                    while ($rowP = mysqli_fetch_assoc($queryP)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="accept.php" class="status" method="POST">
                                    <input type="number" name="CheckpointID" id="CheckpointID" value="<?php echo $rowP['CheckpointID']; ?>" hidden>
                                    <input type="submit" name="Approve" id="Approve" value="Approve" class="a-btn">
                                </form>
                            </td>
